...
namespace TDS_Client.Manager.MapCreator
{
    static class ObjectsManager
    {
        ...
        public static MapCreatorObject GetTeamSpawn(int editingTeamIndex, ushort playerRemoteId, int id = -1)
        {
            ...
            var obj = new Ped(Constants.TeamSpawnPedHash[pedHashIndex], Player.LocalPlayer.Position, Player.LocalPlayer.GetHeading(), dimension: Player.LocalPlayer.Dimension);
        ...
        public static MapCreatorObject GetMapCenter(ushort playerRemoteId, int id = -1)
        {
            ...
            if (entry.Value != null)
                return entry.Value;
            return GetObject(Constants.MapCenterHash, MapCreatorPositionType.MapCenter, playerRemoteId, id: id);
        }

        public static MapCreatorObject GetMapLimit(ushort playerRemoteId, int id = -1)
        {
            return GetObject(Constants.MapLimitHash, MapCreatorPositionType.MapLimit, playerRemoteId, id: id);
        }

        public static MapCreatorObject GetBombPlantPlace(ushort playerRemoteId, int id = -1)
        {
            return GetObject(Constants.BombPlantPlaceHash, MapCreatorPositionType.BombPlantPlace, playerRemoteId, id: id);
        }
        ...
        public static MapCreatorObject GetTarget(ushort playerRemoteId, int id = -1)
        {
            ...
            if (entry.Value != null)
                return entry.Value;
            return GetObject(Constants.TargetHash, MapCreatorPositionType.Target, playerRemoteId, id: id);
        }
