...
namespace TDS_Client.Instance.Draw
{
    internal class FloatingDamageInfo
    {
        ...
        private void UpdatePosition()
        {
            ...
            if (text == null)
                text = new DxText(damage.ToString(), screenX, screenY, 0.4f, Color.White, alignmentX: UIResText.Alignment.Centered, ToServerEvent: ToServerEvent.Bottom, dropShadow: true, outline: true);
            else
