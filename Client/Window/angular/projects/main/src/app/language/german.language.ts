...
WARNUNG! Leerzeichen werden entfernt und neue Zeilen mit einem bereits verwendeten Befehl werden nicht gespeichert!`;
    ...
    AllowDataTransferSettingInfo =
        'Falls TDS-V mal an jemand anderen weitergegeben werden sollte, werden deine Daten nur mit deiner Erlaubnis mit gegeben.\nMehr Infos im FAQ.';
    ...
    HudAmmoUpdateCooldownMsSettingInfo =
        'Der Cooldown zwischen zwei Ammo Updates für das Hud.\nHöherer Cooldown bedeutet bessere Performance während man schießt.\nNutze -1, um Update ganz auszuschalten.';
    HudHealthUpdateCooldownMs = 'Cooldown zwischen Leben Updates im Hud (ms)';
    HudHealthUpdateCooldownMsSettingInfo =
        'Der Cooldown zwischen zwei Weste + Leben Updates für das Hud.\nHöherer Cooldown bedeutet bessere Performance während man Schaden erleidet.\nNutze -1, um Update ganz auszuschalten.';
    CheckAFK = 'Prüfe AFK';
    CheckAFKSettingInfo =
        'Prüft in einer offiziellen Arena Lobby, ob du AFK bist, warnt und kickt dich aus der Lobby um zu verhindern, dass du in mehreren Runden einfach getötet wirst, während du AFK bist.\nEs ist nur zu deinem Besten, also wenn dir das egal ist, deaktiviere es.';
...
Du brauchst mindestens ein Ziel für diesen Mode.`;
    ...
    GangShort = 'Gang-Kürzel';
    RanksPermissions = 'Rang-Befugnisse';
    GangMenu = 'Gang-Menü';
    Administration = 'Administration';
    ManageRanks = 'Verwaltung der Ränge';
    ManageRanksHint = 'Ab welchem Rang sollte man die Ränge verwalten dürfen?';
    ManagePermissions = 'Verwaltung der Befugnisse';
    ManagePermissionsHint = 'Ab welchem Rang sollte man die Befugnisse verwalten dürfen (dieses Fenster)?';
    Member = 'Mitglied';
    Action = 'Aktion';
    InviteMembers = 'Einladen von Mitgliedern';
    InviteMembersHint = 'Ab welchem Rang sollte man Mitglieder einladen dürfen?';
    KickMembers = 'Mitglieder rausschmeißen';
    KickMembersHint = 'Ab welchem Rang sollte man Mitglieder (in unteren Rängen) rausschmeißen dürfen?';
    StartGangAction = 'Gang-Aktion starten';
    StartGangActionHint = 'Ab welchem Rang sollte man eine Gang-Aktion starten dürfen (z.B. Gangwar)?';
    GangInfo = 'Gang Infos';
    Members = 'Mitglieder';
    Ranks = 'Ränge';
    RanksLevels = 'Rang-Levels';
    AllGangs = 'Alle Gangs';
    CreateGang = 'Erstelle Gang';
    GangSuccessfullyCreatedInfo = 'Die Gang wurde erfolgreich erstellt.';
    LeaveGang = 'Verlasse Gang';
    ...
    RankLevelsModifyInfo =
        'Warnung: Verändern der Rang-Level kann dafür sorgen, dass Mitglieder Rang-Ups/-Downs bekommen.\nÜberprüfe die Mitglieder-Ränge nach dem Speichern der Ränge!';
    LoadingDataFailed = 'Laden der Daten ist fehlgeschlagen.';
    LastLoginDate = 'Letztes Login-Datum';
    RankUp = 'Rang-Up';
    RankDown = 'Rang-Down';
    Rank = 'Rang';
    ...
    HudDesignInfo =
        'Falls du willst, kannst du dein eigenes Hud-Design senden. Zeichne ein Bild mit so vielen Details wie nur möglich und sende es an hud@tds-v.com oder in Discord.';
    NoHudDesign = 'GTA 5';
    ...
    DatasLoadingInfo = 'Daten werden geladen.\nBitte warten ...';
    ErrornotOnlyNumbers = 'Nur Zahlen zu nutzen ist nicht erlaubt.';
    ErrornotAllowedCharacter = 'Du hast ein nicht erlaubtes Zeichen benutzt.';
    NameCheck = 'Namensprüfung';
    PasswordCheck = 'Passwort-Prüfung';
    PasswordSameCheck = 'Passwort-Validierung';
    WelcomeBack = 'Willkommen zurück.\nBitte melde dich an!';
    AreYouAlreadyRegisteredQuestion = 'Bist du bereits registriert?';
    RegisterInfo = 'Registriere dich, um spielen zu können.';
    Erroremail = 'Die angegebene E-Mail Adresse ist ungültig.';
    EmailCheck = 'Email-Prüfung';
    Min = 'Min.';
    Max = 'Max.';
    Actual = 'Aktuell';
    EmailAddressRegister = 'E-Mail Adresse für Passwort-Wiederherstellung';
...
Mit Ablauf der 2 Wochen werden alle Daten zur Bewerbung (also auch Einladungen) gelöscht.`;
    ...
    ConfirmTeamAdminApply =
        'Ich bestätige, dass ich mit der Team-Hierarchie einverstanden bin und auf die Mitglieder weiter oben in der Hierarchie hören werde.';
    ConfirmNoAbuseAdminApply =
        'Ich bestätige, dass ich als Supporter meine Rechte niemals ausnutzen würde und bei Ausnutzung sogar vom Server ausgeschlossen werden könnte.';
    ConfirmStatsVisibleAdminApply =
        'Ich bestätige, dass durch meine Bewerbung alle meine für die Bewerbung interessanten Daten für alle Team-Mitglieder (auch obwohl sie evtl. dafür keine Berechtigung haben könnten) sichtbar gemacht werden können.';
