...
export interface Language {
    ...
    DatasLoadingInfo: string;
    ErrornotOnlyNumbers: string;
    ErrornotAllowedCharacter: string;
    NameCheck: string;
    PasswordCheck: string;
    PasswordSameCheck: string;
    WelcomeBack: string;
    AreYouAlreadyRegisteredQuestion: string;
    RegisterInfo: string;
    Erroremail: string;
    EmailCheck: string;
    Min: string;
    Max: string;
    Actual: string;
    EmailAddressRegister: string;
    PasswordForgotten: string;
    RequestNewPassword: string;
    PasswordForgottenInfo: string;
