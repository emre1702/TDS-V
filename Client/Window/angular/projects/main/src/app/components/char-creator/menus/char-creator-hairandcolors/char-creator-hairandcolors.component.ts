...
export class CharCreatorHairandcolorsComponent implements OnInit, OnDestroy {
    ...
    onHairChanged(event: MatSelectChange) {
        ...
        this.rageConnector.call(ToClientEvent.CharCreatorDataChanged, CharCreatorDataKey.Hair, this.data[0]);
    }
    ...
    onHairColorChanged(event: { srcElement: { value: string } }) {
        ...
        this.rageConnector.call(ToClientEvent.CharCreatorDataChanged, CharCreatorDataKey.HairColor, this.data[1], this.data[2]);
    }
    ...
    onEyebrowColorChanged(event: { srcElement: { value: string } }) {
        ...
        this.rageConnector.call(ToClientEvent.CharCreatorDataChanged, CharCreatorDataKey.EyebrowColor, this.data[3]);
    }
    ...
    onFacialHairColorColorChanged(event: { srcElement: { value: string } }) {
        ...
        this.rageConnector.call(ToClientEvent.CharCreatorDataChanged, CharCreatorDataKey.FacialHairColor, this.data[4]);
    }
    ...
    onEyeColorChanged(event: MatSelectChange) {
        ...
        this.rageConnector.call(ToClientEvent.CharCreatorDataChanged, CharCreatorDataKey.EyeColor, this.data[5]);
    }
    ...
    onBlushColorChanged(event: { srcElement: { value: string } }) {
        ...
        this.rageConnector.call(ToClientEvent.CharCreatorDataChanged, CharCreatorDataKey.BlushColor, this.data[6]);
    }
    ...
    onLipstickColorChanged(event: { srcElement: { value: string } }) {
        ...
        this.rageConnector.call(ToClientEvent.CharCreatorDataChanged, CharCreatorDataKey.LipstickColor, this.data[7]);
    }
    ...
    onChestHairColorChanged(event: { srcElement: { value: string } }) {
        ...
        this.rageConnector.call(ToClientEvent.CharCreatorDataChanged, CharCreatorDataKey.ChestHairColor, this.data[8]);
    }
