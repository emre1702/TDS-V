...
export class UserpanelSettingsIngameColorsComponent implements OnInit {
    userpanelSettings: (SettingRow | ButtonRow)[] = [
        ...
        new ColorSettingRow({
            ...
            dataSettingIndex: SettingsIngameColorsIndex.MapBorderColor,
        ...
        new ColorSettingRow({
            ...
            dataSettingIndex: SettingsIngameColorsIndex.NametagDeadColor,
        ...
        new ColorSettingRow({
            ...
            dataSettingIndex: SettingsIngameColorsIndex.NametagHealthEmptyColor,
        ...
        new ColorSettingRow({
            ...
            dataSettingIndex: SettingsIngameColorsIndex.NametagHealthFullColor,
        ...
        new ColorSettingRow({
            ...
            dataSettingIndex: SettingsIngameColorsIndex.NametagArmorEmptyColor,
        ...
        new ColorSettingRow({
            ...
            dataSettingIndex: SettingsIngameColorsIndex.NametagArmorFullColor,
    ...
    constructor(private userpanelSettingsService: UserpanelSettingsNormalService, private rageConnector: RageConnectorService) {}
    ...
    changed(event: SettingChangedEvent) {
        ...
        this.rageConnector.call(ToClientEvent.OnColorSettingChange, index, event.value);
    }
