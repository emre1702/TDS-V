...
export class UserpanelComponent implements OnInit, OnDestroy {
    ...
    ngOnDestroy() {
        ...
        if (this.navigatedToSettingsNormal) {
            this.rageConnector.callServer(ToServerEvent.ReloadPlayerSettings);
        }
    }

    closeUserpanel() {
        this.userpanelService.loadingData = false;
        this.rageConnector.call(ToClientEvent.CloseUserpanel);
    }
    ...
    gotoNav(nav: UserpanelNavPage) {
        ...
        /*if (this.userpanelService.currentNav.startsWith("Commands") && !this.userpanelService.allCommands.length) {
            ...
            this.userpanelService.currentNav.startsWith('Rules') &&
            !this.userpanelService.allRules.length
        ) {
