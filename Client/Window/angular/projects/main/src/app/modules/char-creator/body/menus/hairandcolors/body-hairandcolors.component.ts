...
import { BodyHairAndColorsData } from '../../models/body-hair-and-colors-data';
...
@Component({
    ...
    selector: 'body-hairandcolors',
    templateUrl: './body-hairandcolors.component.html',
    styleUrls: ['./body-hairandcolors.component.scss'],
})
export class BodyHairandcolorsComponent implements OnInit, OnDestroy {
    @Input() data: BodyHairAndColorsData;
    @Output() dataChange = new EventEmitter<BodyHairAndColorsData>();
    ...
    onHairChanged(event: MatSelectChange) {
        ...
        this.rageConnector.call(ToClientEvent.BodyDataChanged, BodyDataKey.Hair, this.data[0]);
    }
    ...
    onHairColorChanged(event: { srcElement: { value: string } }) {
        ...
        this.rageConnector.call(ToClientEvent.BodyDataChanged, BodyDataKey.HairColor, this.data[1], this.data[2]);
    }
    ...
    onEyebrowColorChanged(event: { srcElement: { value: string } }) {
        ...
        this.rageConnector.call(ToClientEvent.BodyDataChanged, BodyDataKey.EyebrowColor, this.data[3]);
    }
    ...
    onFacialHairColorColorChanged(event: { srcElement: { value: string } }) {
        ...
        this.rageConnector.call(ToClientEvent.BodyDataChanged, BodyDataKey.FacialHairColor, this.data[4]);
    }
    ...
    onEyeColorChanged(event: MatSelectChange) {
        ...
        this.rageConnector.call(ToClientEvent.BodyDataChanged, BodyDataKey.EyeColor, this.data[5]);
    }
    ...
    onBlushColorChanged(event: { srcElement: { value: string } }) {
        ...
        this.rageConnector.call(ToClientEvent.BodyDataChanged, BodyDataKey.BlushColor, this.data[6]);
    }
    ...
    onLipstickColorChanged(event: { srcElement: { value: string } }) {
        ...
        this.rageConnector.call(ToClientEvent.BodyDataChanged, BodyDataKey.LipstickColor, this.data[7]);
    }
    ...
    onChestHairColorChanged(event: { srcElement: { value: string } }) {
        ...
        this.rageConnector.call(ToClientEvent.BodyDataChanged, BodyDataKey.ChestHairColor, this.data[8]);
    }
