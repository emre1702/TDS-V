...
-- Exportiere Daten aus Tabelle tdsnew.logs_chat: ~10 rows (ungefähr)
...
CREATE TABLE IF NOT EXISTS `logs_rest` (
  ...
  `Timestamp` timestamp NOT NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=2147484719 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Exportiere Daten aus Tabelle tdsnew.logs_rest: ~68 rows (ungefähr)
...
INSERT INTO `players` (`ID`, `SCName`, `Name`, `Password`, `Email`, `AdminLvl`, `IsVIP`, `Donation`, `RegisterTimestamp`) VALUES
	...
	(1, 'Bonus1702', 'Bonus1702', '8fa23dab9fc54a8702a7b15fb36974711668e07d2509297e695e18c561e7c2b8cfaab9b1994909c5f08eb83c5da8b34c', 'emre1702@live.de', 0, b'0', 0, '2019-02-03 02:00:26');
...
INSERT INTO `player_settings` (`ID`, `HitsoundOn`, `Language`, `AllowDataTransfer`) VALUES
	(1, b'1', 9, b'0');
...
INSERT INTO `player_stats` (`ID`, `Money`, `PlayTime`, `MuteTime`, `LoggedIn`, `LastLoginTimestamp`) VALUES
	(1, 0, 0, NULL, b'1', '2019-02-03 02:00:26');
