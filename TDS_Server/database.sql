...
CREATE TABLE IF NOT EXISTS `logs_admin` (
  ...
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=52 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Also used for VIP and Donator';

-- Exportiere Daten aus Tabelle tdsnew.logs_admin: ~50 rows (ungefähr)
...
CREATE TABLE IF NOT EXISTS `logs_rest` (
  ...
  `Timestamp` timestamp NOT NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=2147484814 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Exportiere Daten aus Tabelle tdsnew.logs_rest: ~147 rows (ungefähr)
