...
-- Exportiere Daten aus Tabelle tdsnew.commands_alias: ~57 rows (ungefähr)
...
-- Exportiere Daten aus Tabelle tdsnew.logs_chat: ~24 rows (ungefähr)
...
CREATE TABLE IF NOT EXISTS `logs_rest` (
  ...
  `Timestamp` timestamp NOT NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=2147484775 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Exportiere Daten aus Tabelle tdsnew.logs_rest: ~124 rows (ungefähr)
...
INSERT INTO `player_stats` (`ID`, `Money`, `PlayTime`, `MuteTime`, `LoggedIn`, `LastLoginTimestamp`) VALUES
	(1, 0, 0, NULL, b'0', '2019-02-03 02:00:26');
