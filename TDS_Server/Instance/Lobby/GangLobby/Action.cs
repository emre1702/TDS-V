...
namespace TDS_Server.Instance.Lobby
{
    partial class GangLobby
    {
        ...
        private bool CheckCanStartAction(TDSPlayer attacker, GangwarArea gangwarArea)
        {
        ...
        private bool CheckCanStartGangwar(TDSPlayer attacker, GangwarArea gangwarArea)
        {
