...
namespace TDS_Server.Handler.Entities.GTA.GTAPlayer
{
    partial class TDSPlayer
    {
        ...
        public override IDatabaseEntityWrapper Database { get; }

        public override Players? Entity
        {
            get => _entity;
            set
            {
        ...
        public override async void CheckSaveData()
        {
        ...
        public override async ValueTask SaveData(bool force = false)
        {
