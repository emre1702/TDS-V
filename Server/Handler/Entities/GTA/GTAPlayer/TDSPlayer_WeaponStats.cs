...
namespace TDS_Server.Handler.Entities.GTA.GTAPlayer
{
    ...
    {
        public override Dictionary<WeaponHash, Dictionary<PedBodyPart, PlayerWeaponBodypartStats>>? WeaponBodyPartsStats { get; set; }
        public override Dictionary<WeaponHash, PlayerWeaponStats>? WeaponStats { get; set; }
        ...
        public override void AddWeaponShot(WeaponHash weaponHash, PedBodyPart? pedBodyPart, int? damage, bool killed)
        {
            if (Entity is null)
                return;
