...
namespace TDS.Server.Handler.Commands.User
{
    public class UserPrivateChatCommands
    {
        ...
        public void PrivateChat(ITDSPlayer player, [RemainingText] string message)
        {
        ...
        public void PrivateMessage(ITDSPlayer player, ITDSPlayer target, [RemainingText] string message)
        {
            if (player == target)
                return;
