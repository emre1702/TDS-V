...
namespace TDS.Server.Handler.Commands.Admin
{
    public class AdminBanCommands
    {
        ...
        public async Task BanPlayer(ITDSPlayer player, TDSCommandInfos cmdinfos, ITDSPlayer target, TimeSpan length, [RemainingText(MinLength = 4)] string reason)
        {
            PlayerBans? ban = null;
        ...
        public async Task BanPlayer(ITDSPlayer player, TDSCommandInfos cmdinfos, Players dbTarget, TimeSpan length, [RemainingText(MinLength = 4)] string reason)
        {
            if (length == TimeSpan.MinValue)
        ...
        public async Task LobbyBanPlayer(ITDSPlayer player, TDSCommandInfos cmdinfos, ITDSPlayer target, TimeSpan length, [RemainingText(MinLength = 4)] string reason)
        {
        ...
        public async Task LobbyBanPlayer(ITDSPlayer player, TDSCommandInfos cmdinfos, Players dbTarget, TimeSpan length, [RemainingText(MinLength = 4)] string reason)
        {
