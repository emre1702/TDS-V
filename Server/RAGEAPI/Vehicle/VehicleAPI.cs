...
namespace TDS_Server.RAGEAPI.Vehicle
{
    ...
    {
        public IVehicle Create(VehicleHash model, Position pos, Position rot, int color1, int color2, string numberPlate = "", byte alpha = 255, bool locked = false, bool engine = true, uint dimension = 0)
        {
        ...
        public IVehicle Create(int model, Position pos, Position rot, int color1, int color2, string numberPlate = "", byte alpha = 255, bool locked = false, bool engine = true, uint dimension = 0)
        {
        ...
        public IVehicle Create(uint model, Position pos, float rot, int color1, int color2, string numberPlate = "", byte alpha = 255, bool locked = false, bool engine = true, uint dimension = 0)
        {
        ...
        public IVehicle Create(VehicleHash model, Position pos, float rot, int color1, int color2, string numberPlate = "", byte alpha = 255, bool locked = false, bool engine = true, uint dimension = 0)
        {
        ...
        public IVehicle Create(VehicleHash model, Position pos, float rot, Color color1, Color color2, string numberPlate = "", byte alpha = 255, bool locked = false, bool engine = true, uint dimension = 0)
        {
        ...
        public IVehicle Create(int model, Position pos, float rot, int color1, int color2, string numberPlate = "", byte alpha = 255, bool locked = false, bool engine = true, uint dimension = 0)
        {
            var instance = GTANetworkAPI.NAPI.Vehicle.CreateVehicle(model, pos.ToMod(), rot, color1, color2, numberPlate, alpha, locked, engine, dimension: dimension);
            return (Vehicle)instance;
        }
        ...
        public void ExplodeVehicle(IVehicle vehicle)
            => GTANetworkAPI.NAPI.Vehicle.ExplodeVehicle(vehicle as Vehicle);

        public float GetVehicleBodyHealth(IVehicle vehicle)
            => GTANetworkAPI.NAPI.Vehicle.GetVehicleBodyHealth(vehicle as Vehicle);

        public bool GetVehicleBulletproofTyres(IVehicle vehicle)
            => GTANetworkAPI.NAPI.Vehicle.GetVehicleBulletproofTyres(vehicle as Vehicle);
        ...
        public Color GetVehicleCustomPrimaryColor(IVehicle vehicle)
            => GTANetworkAPI.NAPI.Vehicle.GetVehicleCustomPrimaryColor(vehicle as Vehicle).ToTDS();

        public Color GetVehicleCustomSecondaryColor(IVehicle vehicle)
            => GTANetworkAPI.NAPI.Vehicle.GetVehicleCustomSecondaryColor(vehicle as Vehicle).ToTDS();

        public bool GetVehicleCustomTires(IVehicle vehicle)
            => GTANetworkAPI.NAPI.Vehicle.GetVehicleCustomTires(vehicle as Vehicle);

        public int GetVehicleDashboardColor(IVehicle vehicle)
            => GTANetworkAPI.NAPI.Vehicle.GetVehicleDashboardColor(vehicle as Vehicle);
        ...
        public IEntity? GetVehicleDriver(IVehicle vehicle)
            => GTANetworkAPI.NAPI.Vehicle.GetVehicleDriver(vehicle as Vehicle) as IEntity;

        public float GetVehicleEngineHealth(IVehicle vehicle)
            => GTANetworkAPI.NAPI.Vehicle.GetVehicleEngineHealth(vehicle as Vehicle);

        public float GetVehicleEnginePowerMultiplier(IVehicle vehicle)
            => GTANetworkAPI.NAPI.Vehicle.GetVehicleEnginePowerMultiplier(vehicle as Vehicle);

        public bool GetVehicleEngineStatus(IVehicle vehicle)
            => GTANetworkAPI.NAPI.Vehicle.GetVehicleEngineStatus(vehicle as Vehicle);

        public float GetVehicleEngineTorqueMultiplier(IVehicle vehicle)
            => GTANetworkAPI.NAPI.Vehicle.GetVehicleEngineTorqueMultiplier(vehicle as Vehicle);

        public bool GetVehicleExtra(IVehicle vehicle, int slot)
            => GTANetworkAPI.NAPI.Vehicle.GetVehicleExtra(vehicle as Vehicle, slot);

        public float GetVehicleHealth(IVehicle vehicle)
            => GTANetworkAPI.NAPI.Vehicle.GetVehicleHealth(vehicle as Vehicle);

        public int GetVehicleLivery(IVehicle vehicle)
            => GTANetworkAPI.NAPI.Vehicle.GetVehicleLivery(vehicle as Vehicle);

        public bool GetVehicleLocked(IVehicle vehicle)
            => GTANetworkAPI.NAPI.Vehicle.GetVehicleLocked(vehicle as Vehicle);
        ...
        public int GetVehicleMod(IVehicle vehicle, int slot)
            => GTANetworkAPI.NAPI.Vehicle.GetVehicleMod(vehicle as Vehicle, slot);

        public Color GetVehicleNeonColor(IVehicle vehicle)
            => GTANetworkAPI.NAPI.Vehicle.GetVehicleNeonColor(vehicle as Vehicle).ToTDS();

        public bool GetVehicleNeonState(IVehicle vehicle)
            => GTANetworkAPI.NAPI.Vehicle.GetVehicleNeonState(vehicle as Vehicle);

        public string GetVehicleNumberPlate(IVehicle vehicle)
            => GTANetworkAPI.NAPI.Vehicle.GetVehicleNumberPlate(vehicle as Vehicle);

        public int GetVehicleNumberPlateStyle(IVehicle vehicle)
            => GTANetworkAPI.NAPI.Vehicle.GetVehicleNumberPlateStyle(vehicle as Vehicle);
        ...
        public int GetVehiclePearlescentColor(IVehicle vehicle)
            => GTANetworkAPI.NAPI.Vehicle.GetVehiclePearlescentColor(vehicle as Vehicle);

        public int GetVehiclePrimaryColor(IVehicle vehicle)
            => GTANetworkAPI.NAPI.Vehicle.GetVehiclePrimaryColor(vehicle as Vehicle);

        public VehiclePaint GetVehiclePrimaryPaint(IVehicle vehicle)
        => GTANetworkAPI.NAPI.Vehicle.GetVehiclePrimaryPaint(vehicle as Vehicle).ToTDS();

        public int GetVehicleSecondaryColor(IVehicle vehicle)
        => GTANetworkAPI.NAPI.Vehicle.GetVehicleSecondaryColor(vehicle as Vehicle);

        public VehiclePaint GetVehicleSecondaryPaint(IVehicle vehicle)
        => GTANetworkAPI.NAPI.Vehicle.GetVehicleSecondaryPaint(vehicle as Vehicle).ToTDS();

        public bool GetVehicleSirenState(IVehicle vehicle)
        => GTANetworkAPI.NAPI.Vehicle.GetVehicleSirenState(vehicle as Vehicle);

        public bool GetVehicleSpecialLightStatus(IVehicle vehicle)
        => GTANetworkAPI.NAPI.Vehicle.GetVehicleSpecialLightStatus(vehicle as Vehicle);

        public IVehicle? GetVehicleTrailer(IVehicle vehicle)
            => vehicle.Trailer;

        public IVehicle? GetVehicleTraileredBy(IVehicle vehicle)
            => vehicle.TraileredBy;

        public int GetVehicleTrimColor(IVehicle vehicle)
        => GTANetworkAPI.NAPI.Vehicle.GetVehicleTrimColor(vehicle as Vehicle);

        public Color GetVehicleTyreSmokeColor(IVehicle vehicle)
        => GTANetworkAPI.NAPI.Vehicle.GetVehicleTyreSmokeColor(vehicle as Vehicle).ToTDS();

        public int GetVehicleWheelColor(IVehicle vehicle)
        => GTANetworkAPI.NAPI.Vehicle.GetVehicleWheelColor(vehicle as Vehicle);

        public int GetVehicleWheelType(IVehicle vehicle)
        => GTANetworkAPI.NAPI.Vehicle.GetVehicleWheelType(vehicle as Vehicle);

        public int GetVehicleWindowTint(IVehicle vehicle)
        => GTANetworkAPI.NAPI.Vehicle.GetVehicleWindowTint(vehicle as Vehicle);

        public void RemoveVehicleMod(IVehicle vehicle, int modType)
        => GTANetworkAPI.NAPI.Vehicle.RemoveVehicleMod(vehicle as Vehicle, modType);

        public void RepairVehicle(IVehicle vehicle)
        => GTANetworkAPI.NAPI.Vehicle.RepairVehicle(vehicle as Vehicle);

        public void SetVehicleBodyHealth(IVehicle vehicle, float health)
        => GTANetworkAPI.NAPI.Vehicle.SetVehicleBodyHealth(vehicle as Vehicle, health);

        public void SetVehicleBulletproofTyres(IVehicle vehicle, bool state)
        => GTANetworkAPI.NAPI.Vehicle.SetVehicleBulletproofTyres(vehicle as Vehicle, state);

        public void SetVehicleCustomPrimaryColor(IVehicle vehicle, int red, int green, int blue)
        => GTANetworkAPI.NAPI.Vehicle.SetVehicleCustomPrimaryColor(vehicle as Vehicle, red, green, blue);

        public void SetVehicleCustomSecondaryColor(IVehicle vehicle, int red, int green, int blue)
        => GTANetworkAPI.NAPI.Vehicle.SetVehicleCustomSecondaryColor(vehicle as Vehicle, red, green, blue);

        public void SetVehicleCustomTires(IVehicle vehicle, bool enable)
        => GTANetworkAPI.NAPI.Vehicle.SetVehicleCustomTires(vehicle as Vehicle, enable);

        public void SetVehicleDashboardColor(IVehicle vehicle, int type)
        => GTANetworkAPI.NAPI.Vehicle.SetVehicleDashboardColor(vehicle as Vehicle, type);

        public void SetVehicleEngineHealth(IVehicle vehicle, float health)
        => GTANetworkAPI.NAPI.Vehicle.SetVehicleEngineHealth(vehicle as Vehicle, health);

        public void SetVehicleEnginePowerMultiplier(IVehicle vehicle, float mult)
        => GTANetworkAPI.NAPI.Vehicle.SetVehicleEnginePowerMultiplier(vehicle as Vehicle, mult);

        public void SetVehicleEngineStatus(IVehicle vehicle, bool state)
        => GTANetworkAPI.NAPI.Vehicle.SetVehicleEngineStatus(vehicle as Vehicle, state);

        public void SetVehicleEngineTorqueMultiplier(IVehicle vehicle, float mult)
        => GTANetworkAPI.NAPI.Vehicle.SetVehicleEngineTorqueMultiplier(vehicle as Vehicle, mult);

        public void SetVehicleExtra(IVehicle vehicle, int slot, bool enabled)
        => GTANetworkAPI.NAPI.Vehicle.SetVehicleExtra(vehicle as Vehicle, slot, enabled);

        public void SetVehicleHealth(IVehicle vehicle, float health)
        => GTANetworkAPI.NAPI.Vehicle.SetVehicleHealth(vehicle as Vehicle, health);

        public void SetVehicleLivery(IVehicle vehicle, int livery)
        => GTANetworkAPI.NAPI.Vehicle.SetVehicleLivery(vehicle as Vehicle, livery);

        public void SetVehicleLocked(IVehicle vehicle, bool locked)
        => GTANetworkAPI.NAPI.Vehicle.SetVehicleLocked(vehicle as Vehicle, locked);

        public void SetVehicleMod(IVehicle vehicle, int modType, int mod)
        => GTANetworkAPI.NAPI.Vehicle.SetVehicleMod(vehicle as Vehicle, modType, mod);

        public void SetVehicleNeonColor(IVehicle vehicle, int r, int g, int b)
        => GTANetworkAPI.NAPI.Vehicle.SetVehicleNeonColor(vehicle as Vehicle, r, g, b);

        public void SetVehicleNeonState(IVehicle vehicle, bool turnedOn)
        => GTANetworkAPI.NAPI.Vehicle.SetVehicleNeonState(vehicle as Vehicle, turnedOn);

        public void SetVehicleNumberPlate(IVehicle vehicle, string plate)
        => GTANetworkAPI.NAPI.Vehicle.SetVehicleNumberPlate(vehicle as Vehicle, plate);

        public void SetVehicleNumberPlateStyle(IVehicle vehicle, int style)
        => GTANetworkAPI.NAPI.Vehicle.SetVehicleNumberPlateStyle(vehicle as Vehicle, style);

        public void SetVehiclePearlescentColor(IVehicle vehicle, int color)
        => GTANetworkAPI.NAPI.Vehicle.SetVehiclePearlescentColor(vehicle as Vehicle, color);

        public void SetVehiclePrimaryColor(IVehicle vehicle, int color)
        => GTANetworkAPI.NAPI.Vehicle.SetVehiclePrimaryColor(vehicle as Vehicle, color);

        public void SetVehiclePrimaryPaint(IVehicle vehicle, int paintType, int color)
        => GTANetworkAPI.NAPI.Vehicle.SetVehiclePrimaryPaint(vehicle as Vehicle, paintType, color);

        public void SetVehicleSecondaryColor(IVehicle vehicle, int color)
        => GTANetworkAPI.NAPI.Vehicle.SetVehicleSecondaryColor(vehicle as Vehicle, color);

        public void SetVehicleSecondaryPaint(IVehicle vehicle, int paintType, int color)
        => GTANetworkAPI.NAPI.Vehicle.SetVehicleSecondaryPaint(vehicle as Vehicle, paintType, color);

        public void SetVehicleSirenState(IVehicle vehicle, bool state)
        => GTANetworkAPI.NAPI.Vehicle.SetVehicleSirenState(vehicle as Vehicle, state);

        public void SetVehicleSpecialLightStatus(IVehicle vehicle, bool state)
        => GTANetworkAPI.NAPI.Vehicle.SetVehicleSpecialLightStatus(vehicle as Vehicle, state);

        public void SetVehicleTrimColor(IVehicle vehicle, int type)
        => GTANetworkAPI.NAPI.Vehicle.SetVehicleTrimColor(vehicle as Vehicle, type);

        public void SetVehicleTyreSmokeColor(IVehicle vehicle, Color color)
        => GTANetworkAPI.NAPI.Vehicle.SetVehicleTyreSmokeColor(vehicle as Vehicle, color.ToMod());

        public void SetVehicleWheelColor(IVehicle vehicle, int color)
        => GTANetworkAPI.NAPI.Vehicle.SetVehicleWheelColor(vehicle as Vehicle, color);

        public void SetVehicleWheelType(IVehicle vehicle, int type)
        => GTANetworkAPI.NAPI.Vehicle.SetVehicleWheelType(vehicle as Vehicle, type);

        public void SetVehicleWindowTint(IVehicle vehicle, int type)
            => GTANetworkAPI.NAPI.Vehicle.SetVehicleWindowTint(vehicle as Vehicle, type);

        public void SpawnVehicle(IVehicle vehicle, Position position, float heading = 0)
            => GTANetworkAPI.NAPI.Vehicle.SpawnVehicle(vehicle as Vehicle, position.ToMod(), heading);
    }
}
