...
{
    internal class TextLabel : GTANetworkAPI.TextLabel, ITextLabel
    {
        #region Public Constructors

        public TextLabel(GTANetworkAPI.NetHandle netHandle)
            : base(netHandle) { }
        ...
        {
            get => base.Color.ToTDS();
            set => base.Color = value.ToMod();
        }
