...
{
    public class PlayerBodyAppearanceDatas : IPlayerDataTable
    {
        [JsonIgnore]
    ...
    public class PlayerBodyAppearanceDatasConfiguration : IEntityTypeConfiguration<PlayerBodyAppearanceDatas>
    {
        public void Configure(EntityTypeBuilder<PlayerBodyAppearanceDatas> builder)
        {
