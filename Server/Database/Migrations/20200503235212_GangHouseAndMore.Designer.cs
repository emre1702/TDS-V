...
namespace TDS_Server.Database.Migrations
{
    ...
    [Migration("20200503235212_GangHouseAndMore")]
    partial class GangHouseAndMore
    {
            ...
            modelBuilder.Entity("TDS_Server.Database.Entity.GangEntities.GangLevelSettings", b =>
                {
                    ...
                    b.Property<float>("HouseAreaRadius")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("house_area_radius")
                        .HasColumnType("real")
                        .HasDefaultValue(30f);
            ...
            modelBuilder.Entity("TDS_Server.Database.Entity.GangEntities.GangVehicles", b =>
                {
                    ...
                    b.Property<float>("SpawnPosX")
                        .HasColumnName("spawn_pos_x")
                        .HasColumnType("real");

                    b.Property<float>("SpawnPosY")
                        .HasColumnName("spawn_pos_y")
                        .HasColumnType("real");

                    b.Property<float>("SpawnPosZ")
                        .HasColumnName("spawn_pos_z")
                        .HasColumnType("real");

                    b.Property<float>("SpawnRotX")
                        .HasColumnName("spawn_rot_x")
                        .HasColumnType("real");

                    b.Property<float>("SpawnRotY")
                        .HasColumnName("spawn_rot_y")
                        .HasColumnType("real");

                    b.Property<float>("SpawnRotZ")
                        .HasColumnName("spawn_rot_z")
                        .HasColumnType("real");

                    b.HasKey("Id")
                        .HasName("pk_gang_vehicles");

                    b.HasIndex("GangId")
                        .HasName("ix_gang_vehicles_gang_id");

                    b.ToTable("gang_vehicles");
                });
            ...
            modelBuilder.Entity("TDS_Server.Database.Entity.Player.PlayerSettings", b =>
                {
                    ...
                    b.Property<float>("ChatFontSize")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("chat_font_size")
                        .HasColumnType("real")
                        .HasDefaultValue(1.4f);

                    b.Property<float>("ChatMaxHeight")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("chat_max_height")
                        .HasColumnType("real")
                        .HasDefaultValue(35f);

                    b.Property<float>("ChatWidth")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("chat_width")
                        .HasColumnType("real")
                        .HasDefaultValue(30f);
                    ...
                    b.Property<bool>("ShowCursorOnChatOpen")
                        .HasColumnName("show_cursor_on_chat_open")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("TDS_Server.Database.Entity.GangEntities.GangVehicles", b =>
                {
                    b.HasOne("TDS_Server.Database.Entity.GangEntities.Gangs", "Gang")
                        .WithMany("Vehicles")
                        .HasForeignKey("GangId")
                        .HasConstraintName("fk_gang_vehicles_gangs_gang_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
