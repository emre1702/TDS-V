...
{
    public partial class UpdateDBGangs : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    needed_gang_level = table.Column<byte>(nullable: false),
                    ...
                    last_bought = table.Column<DateTime>(nullable: true),
                    creator_id = table.Column<int>(nullable: false),
                    created = table.Column<DateTime>(nullable: false, defaultValueSql: "timezone('utc', now())")
                },
                constraints: table =>
                {
                    table.PrimaryKey("pk_gang_houses", x => x.id);
                    table.ForeignKey(
                        name: "fk_gang_houses_players_creator_id",
            ...
            migrationBuilder.CreateTable(
                name: "gang_level_settings",
                columns: table => new
                {
                    level = table.Column<byte>(nullable: false),
                    upgrade_price = table.Column<int>(nullable: false, defaultValue: 2147483647),
                    house_price = table.Column<int>(nullable: false, defaultValue: 2147483647),
                    needed_experience = table.Column<int>(nullable: false, defaultValue: 2147483647),
                    player_slots = table.Column<byte>(nullable: false, defaultValue: (byte)255),
                    rank_slots = table.Column<byte>(nullable: false, defaultValue: (byte)255),
                    vehicle_slots = table.Column<byte>(nullable: false, defaultValue: (byte)255),
                    gang_area_slots = table.Column<byte>(nullable: false, defaultValue: (byte)255),
                    can_change_blip_color = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("pk_gang_level_settings", x => x.level);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    amount_attacks = table.Column<int>(nullable: false, defaultValue: 0),
                    amount_defends = table.Column<int>(nullable: false, defaultValue: 0),
                    amount_attacks_won = table.Column<int>(nullable: false, defaultValue: 0),
                    amount_defends_won = table.Column<int>(nullable: false, defaultValue: 0),
                    amount_members_so_far = table.Column<int>(nullable: false, defaultValue: 0),
                    peak_gangwar_areas_owned = table.Column<int>(nullable: false, defaultValue: 0),
                    total_money_so_far = table.Column<int>(nullable: false, defaultValue: 0)
                },
                constraints: table =>
                {
                    table.PrimaryKey("pk_gang_stats", x => x.gang_id);
                    table.ForeignKey(
            ...
            migrationBuilder.UpdateData(
                ...
                keyValues: new object[] { 2, Language.German },
                column: "answer",
...
Die Daten beinhalten keine sensiblen Informationen - IPs werden nicht gespeichert, Passwörter sind sicher (Hash + Salt).");
            ...
            migrationBuilder.UpdateData(
                table: "fa_qs",
                keyColumns: new[] { "id", "language" },
                keyValues: new object[] { 2, Language.English },
                column: "answer",
...
The data does not contain any sensitive information - IPs are not stored, passwords are secure (hash + salt).");
            ...
            migrationBuilder.UpdateData(
                ...
                keyColumn: "gang_id",
                keyValue: -1,
                columns: new[] { "invite_members", "kick_members", "manage_permissions", "manage_ranks", "start_gangwar" },
            ...
            migrationBuilder.UpdateData(
                table: "rule_texts",
                keyColumns: new[] { "rule_id", "language" },
                keyValues: new object[] { 1, Language.German },
                column: "rule_str",
...
Wird ein solches Verhalten bemerkt, kann es zu starken Strafen führen und es wird permanent notiert.");
            ...
            migrationBuilder.UpdateData(
                table: "rule_texts",
                keyColumns: new[] { "rule_id", "language" },
                keyValues: new object[] { 1, Language.English },
                column: "rule_str",
...
Admin commands for 'punishing' (kick, mute, ban etc.) may only be used for violations of rules.");
            ...
            migrationBuilder.UpdateData(
                table: "rule_texts",
                keyColumns: new[] { "rule_id", "language" },
                keyValues: new object[] { 5, Language.German },
                column: "rule_str",
...
Zu hohe Zeiten sind schlecht, zu niedrige kein Problem.");
            ...
            migrationBuilder.UpdateData(
                table: "rule_texts",
                keyColumns: new[] { "rule_id", "language" },
                keyValues: new object[] { 5, Language.English },
                column: "rule_str",
...
Too high times are bad, too low times are no problem.");
            ...
            migrationBuilder.CreateIndex(
                name: "ix_gangs_house_id",
                table: "gangs",
                column: "house_id",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "ix_gang_houses_creator_id",
                table: "gang_houses",
                column: "creator_id");
...
The data does not contain any sensitive information - IPs are not stored, passwords are secure (hash + salt).");
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: -1,
                columns: new[] { "invite_members", "kick_members", "manage_permissions", "manage_ranks", "start_gangwar" },
                values: new object[] { (short)5, (short)5, (short)5, (short)5, (short)5 });
...
Too high times are bad, too low times are no problem.");
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: -5,
                columns: new[] { "blip_color", "name" },
                values: new object[] { (short)4, "None" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: -4,
                columns: new[] { "blip_color", "name", "skin_hash" },
                values: new object[] { (short)1, "Terrorist", 275618457 });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: -3,
                columns: new[] { "blip_color", "name", "skin_hash" },
                values: new object[] { (short)52, "SWAT", -1920001264 });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: -2,
                columns: new[] { "blip_color", "name" },
                values: new object[] { (short)4, "Spectator" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: -1,
                columns: new[] { "blip_color", "name", "skin_hash" },
                values: new object[] { (short)4, "Spectator", 1004114196 });
