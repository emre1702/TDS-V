...
namespace TDS.Server.Database.Migrations
{
    ...
    [Migration("20201106175104_KillInfoSettings")]
    partial class KillInfoSettings
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TDS.Server.Database.Entity.Player.PlayerKillInfoSettings", b =>
                {
                    b.Property<int>("PlayerId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TDS.Server.Database.Entity.Player.PlayerKillInfoSettings", b =>
                {
                    b.HasOne("TDS.Server.Database.Entity.Player.Players", "Player")
                        ...
                        .HasForeignKey("TDS.Server.Database.Entity.Player.PlayerKillInfoSettings", "PlayerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
