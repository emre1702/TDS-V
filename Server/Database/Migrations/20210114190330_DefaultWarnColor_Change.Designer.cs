...
namespace TDS.Server.Database.Migrations
{
    ...
    [Migration("20210114190330_DefaultWarnColor_Change")]
    partial class DefaultWarnColor_Change
    {
...
#pragma warning disable 612, 618
            modelBuilder
                ...
                .HasPostgresEnum(null, "clothes_data_key", new[] { "main", "hats", "glasses", "masks", "jackets", "shirts", "hands", "accessories", "bags", "legs", "shoes", "body_armors", "decals", "ear_accessories", "watches", "bracelets", "all", "slot" })
                ...
                .HasPostgresEnum(null, "map_retrieve_type", new[] { "none", "random", "voted", "bought" })
            ...
            modelBuilder.Entity("TDS.Server.Database.Entity.Player.PlayerMapCreatorRewardsWhileOffline", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<MapRetrieveType>("Type")
                        .HasColumnType("map_retrieve_type");
                    ...
                    b.ToTable("PlayerMapCreatorRewardsWhileOffline");
                });
            ...
            modelBuilder.Entity("TDS.Server.Database.Entity.Player.Settings.PlayerHudSettings", b =>
                {
                    b.Property<int>("PlayerId")
                        .HasColumnType("integer");

                    b.Property<string>("HudBackgroundColor")
                        .HasColumnType("text")
                        .HasColumnName("HudBackgroundColor");

                    b.Property<HudDesign>("HudDesign")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("hud_design")
                        .HasDefaultValue(HudDesign.BonusV1)
                        .HasColumnName("HudDesign");

                    b.Property<string>("HudFontColor")
                        .HasColumnType("text")
                        .HasColumnName("HudFontColor");

                    b.Property<int?>("PlayerSettingsPlayerId")
                        .HasColumnType("integer")
                        .HasColumnName("PlayerHudSettings_PlayerSettingsPlayerId");

                    b.Property<string>("RoundStatsBackgroundColor")
                        .HasColumnType("text")
                        .HasColumnName("RoundStatsBackgroundColor");

                    b.Property<string>("RoundStatsFontColor")
                        .HasColumnType("text")
            ...
            modelBuilder.Entity("TDS.Server.Database.Entity.Player.Settings.PlayerThemeSettings", b =>
                {
                    ...
                    b.Property<string>("ThemeMainColor")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text")
                        .HasDefaultValue("rgb(0,0,77)");

                    b.Property<string>("ThemeSecondaryColor")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text")
                        .HasDefaultValue("rgb(255,152,0)");

                    b.Property<string>("ThemeWarnColor")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text")
                        .HasDefaultValue("rgb(150,0,0)");
            ...
            modelBuilder.Entity("TDS.Server.Database.Entity.Server.ServerSettings", b =>
                {
                    ...
                    b.Property<int>("MapCreatorRewardBought")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(15);

                    b.Property<int>("MapCreatorRewardRandomlySelected")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(1);

                    b.Property<int>("MapCreatorRewardVoted")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(5);
            ...
            modelBuilder.Entity("TDS.Server.Database.Entity.Player.Character.Clothes.PlayerClothesComponentOrPropData", b =>
                {
                    b.HasOne("TDS.Server.Database.Entity.Player.Character.Clothes.PlayerClothesData", "Data")
                        .WithMany("ComponentOrPropDatas")
                        .HasForeignKey("PlayerId", "Slot")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("TDS.Server.Database.Entity.Player.PlayerMapCreatorRewardsWhileOffline", b =>
                {
                    b.HasOne("TDS.Server.Database.Entity.Rest.Maps", "Map")
                        .WithMany("CreatorRewardsWhileOffline")
                        .HasForeignKey("MapId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("TDS.Server.Database.Entity.Player.Players", "Player")
                        .WithMany("MapCreatorRewardsWhileOffline")
                        .HasForeignKey("PlayerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("TDS.Server.Database.Entity.Player.Settings.PlayerHudSettings", b =>
                {
                    b.HasOne("TDS.Server.Database.Entity.Player.Settings.PlayerSettings", null)
                        .WithOne("Hud")
                        .HasForeignKey("TDS.Server.Database.Entity.Player.Settings.PlayerHudSettings", "PlayerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("TDS.Server.Database.Entity.Player.Character.Clothes.PlayerClothesData", b =>
                {
                    b.Navigation("ComponentOrPropDatas");
                });
            ...
            modelBuilder.Entity("TDS.Server.Database.Entity.Player.Players", b =>
                {
                    ...
                    b.Navigation("MapCreatorRewardsWhileOffline");
            ...
            modelBuilder.Entity("TDS.Server.Database.Entity.Rest.Maps", b =>
                {
                    b.Navigation("CreatorRewardsWhileOffline");
