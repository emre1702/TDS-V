...
{
    public class CharCreateLobbyBansHandler : BaseLobbyBansHandler
    {
        public CharCreateLobbyBansHandler(BaseLobbyDatabase database, IBaseLobbyEventsHandler events, LangHelper langHelper, BaseLobbyChat chat, LobbyDb entity)
