...
namespace TDS_Server_DB.Migrations
{
    ...
    [Migration("20190929102038_WeaponUpgrades3")]
    partial class WeaponUpgrades3
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TDS_Server_DB.Entity.Player.PlayerWeaponComponents", b =>
                {
                    b.Property<int>("PlayerId")
                        .HasColumnName("PlayerID")
                        .HasColumnType("integer");

                    b.Property<EWeaponHash>("WeaponHash")
                        .HasColumnType("e_weapon_hash");
                    ...
                    b.HasIndex("ComponentHash", "WeaponHash");

                    b.ToTable("player_weapon_components");
                });

            modelBuilder.Entity("TDS_Server_DB.Entity.Player.PlayerWeaponTints", b =>
                {
                    b.Property<int>("PlayerId")
                        .HasColumnName("PlayerID")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("TintId", "IsMK2");

                    b.ToTable("player_weapon_tints");
                });
            ...
            modelBuilder.Entity("TDS_Server_DB.Entity.Rest.WeaponComponents", b =>
                {
                    b.Property<EWeaponComponent>("Hash")
                        .HasColumnType("e_weapon_component");

                    b.Property<EWeaponHash>("WeaponHash")
                        .HasColumnType("e_weapon_hash");

                    b.Property<EWeaponComponentCategory>("Category")
                        .HasColumnType("e_weapon_component_category");

                    b.Property<string>("Name")
                        .HasColumnType("text");

                    b.HasKey("Hash", "WeaponHash");

                    b.HasIndex("WeaponHash");

                    b.ToTable("weapon_components");
            ...
            modelBuilder.Entity("TDS_Server_DB.Entity.Rest.WeaponsTints", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnName("ID")
                        .HasColumnType("integer");
...
Zu hohe Zeiten sind schlecht, zu niedrige kein Problem."
            ...
            modelBuilder.Entity("TDS_Server_DB.Entity.Player.PlayerWeaponComponents", b =>
                {
                    b.HasOne("TDS_Server_DB.Entity.Player.Players", "Player")
                        .WithMany("PlayerWeaponComponents")
                        .HasForeignKey("PlayerId")
                        .HasConstraintName("player_player_weapon_components_PlayerId_fkey")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TDS_Server_DB.Entity.Rest.Weapons", "Weapon")
                        .WithMany("PlayerWeaponComponents")
                    ...
                    b.HasOne("TDS_Server_DB.Entity.Rest.WeaponComponents", "Component")
                        .WithMany("PlayerWeaponComponents")
                        .HasForeignKey("ComponentHash", "WeaponHash")
            ...
            modelBuilder.Entity("TDS_Server_DB.Entity.Player.PlayerWeaponTints", b =>
                {
                    ...
                    b.HasOne("TDS_Server_DB.Entity.Rest.WeaponsTints", "Tint")
                        .WithMany("PlayerWeaponTints")
                        .HasForeignKey("TintId", "IsMK2")
