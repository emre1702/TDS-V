...
namespace TDS_Server_DB.Migrations
{
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.SetDefault, onUpdate: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.InsertData(
                table: "players",
                columns: new[] { "ID", "AdminLeaderID", "AdminLvl", "Email", "Name", "Password", "SCID", "SCName" },
                values: new object[] { -1, null, (short)0, null, "System", "", 0m, "System" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_player_bans_SCId",
                table: "player_bans",
                column: "SCId");

            migrationBuilder.CreateIndex(
                name: "IX_player_bans_SCName",
                table: "player_bans",
                column: "SCName");
