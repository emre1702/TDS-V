...
namespace Manager {
	static class Colors {
		public static ConcurrentDictionary<string, Color> fontColor = new ConcurrentDictionary<string, Color> {
		...
		// unsicher (alles)
		public static ConcurrentDictionary<string, int> blipColorByString = new ConcurrentDictionary<string, int> {
			["r"] = 49,
			["b"] = 38,
			["g"] = 24,
			["y"] = 46,
