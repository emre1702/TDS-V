var scaleformMessage = {
    showShard: ( title, message, titleColor = undefined, bgColor = undefined, time = 5000 ) => mp.events.call( "ShowShardMessage", title, message, titleColor, bgColor, time ),
    ...
    showWastedMessage: ( time = 5000 ) => mp.events.call( "ShowShardWastedMessage", time )
};